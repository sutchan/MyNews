...
sportsPlatforms.value.forEach(platform => {
...
const fetchAllPlatformsData = async () => {
  const promises = sportsPlatforms.value.map(p => fetchPlatformData(p.platform))
